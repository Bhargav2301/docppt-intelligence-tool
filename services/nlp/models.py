...
class UserSettings(Base):
    ...
    default_tone_preset = Column(String, default="presentation_concise")
    default_intensity = Column(String, default="balanced")
    local_model_endpoint = Column(String, default="http://localhost:11434")
